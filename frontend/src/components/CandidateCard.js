    ...
    return (
        ...
        >
            ...
            <div className="flex items-center gap-2 mb-4 flex-wrap">
                ...
                {c.source === 'extension' && (
                    <Badge className="text-xs border rounded-full px-2 py-0.5 bg-ocean/10 text-ocean border-ocean/20" data-testid={`candidate-ext-badge-${c.id}`}>
                        <PuzzlePiece className="w-3 h-3 mr-1" /> Ext
                    </Badge>
                )}
            </div>
